...
(function( $ ){
    $.extend({
        dialog: function(object){
            ...
            var dialogHTML='<div id="'+object.id+'" class="dialog-common '+object.class+'"><p class="dialog-title">'+object.title+'</p><p class="dialog-content">'+object.content+'</p><p class="dialog-buttons">';
            var buttonHTML='';

            $.each(object.buttons,function(key,val){
                buttonHTML=buttonHTML+'<button id="'+key+'">'+key+'</button>   ';
            });
            dialogHTML=dialogHTML+buttonHTML+'</p></div><div id="'+object.id+'-background" class="dialog-background-common '+object.class+'-background"></div>';
