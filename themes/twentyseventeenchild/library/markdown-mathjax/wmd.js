...
Attacklab.wmdBase = function(){
	...
	var helpLink = "https://mathoverflow.net/editing-help";
	var helpHoverTitle = "Editing Help";
	...
	wmd.PanelCollection = function(){
		...
		this.input = doc.getElementById(MyWmdInput);
	};
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			boldButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-bold"></use></svg>'
			...
			italicButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-italic"></use></svg>'
			...
			linkButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-link1"></use></svg>'
			...
			quoteButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-Text-HighlightColor"></use></svg>'
			
			quoteButton.className = "wmd-button";
			quoteButton.id = "wmd-quote-button";
			quoteButton.title = "Highlight <highlight> Ctrl+Q";
			...
			codeButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-code"></use></svg>'
			...
			imageButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-image"></use></svg>'
			...
			olistButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-orderedlist"></use></svg>'
			...
			ulistButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-unorderedlist"></use></svg>'
			...
			headingButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-section"></use></svg>'
			...
			hrButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-dash"></use></svg>'
			...
			undoButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-undo1"></use></svg>'
			...
			redoButton.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-redo1"></use></svg>'
			...
			helpAnchor.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-question"></use></svg>'
	...
	command.doBlockquote = function(chunk, postProcessing, useDefaultText){
		...
		var defaultText = useDefaultText ? "Highlight" : "";
		chunk.selection = chunk.selection.replace(/^(\s|>)+$/ ,"");
