 ...
 */
//The last line include a aboslute url!!!
...
MathJax.Ajax.loadComplete("[Contrib]/xyjax/xypic.js");//!!!aboslute url, should be replace;

//function HomeURL(){var SiteURL=document.getElementById("SiteTitle").innerHTML;SiteURL = SiteURL.substring(SiteURL.indexOf("href") + 5, SiteURL.lastIndexOf(" rel"));return SiteURL;}